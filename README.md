...
- **The detail is in the forms, not in the budget.** The obvious way to draw more is to raise the point budget, and it does not work: the budget governs the generated ground, so turning it up from 11,000 to 21,000 left the authored buildings at exactly 4,341 points and simply laid more speckle around them. What a roof needed was tile courses down both slopes, a verandah, storey bands; what a tree needed was a crown on a stem rather than a blob; what a precinct needed was its wall. Writing those into the primitives took the drawings from a median 626 points to 1,056 and the whole cloud from 141,777 to 177,438, and the frame cost did not move — the heaviest case, dragging at street zoom, measured within 1% of where it was.
