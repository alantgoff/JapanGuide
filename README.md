...
- **The pictures in the panel are drawings, not photographs.** Each one is that place's own points under a different camera, so it is exactly as truthful as the map is and no more. Twenty places have a hand-authored form and show a building; the rest show their surroundings — the lane they are on, the river bank, a neighbour's precinct — which is honest about the fact that the map knows where they are and not what they look like.
